...
#
#   scripts/verify_reference.sh                                  # 500 frames, quick kit
#   scripts/verify_reference.sh --frames all                     # whole quick kit
...
NPZ="${AKIDA_TEST_NPZ:-$HOME/data/voc/VOCdevkit/voc2007_test_r448_first500.npz}"
...
[ -f "$NPZ" ] || { echo "No test kit at $NPZ (pass --npz <path>)." >&2; exit 1; }
